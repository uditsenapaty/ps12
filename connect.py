...
DATA_SETUP_FULL = ("python data_setup.py --download goes --start 2025-10-01 --end 2025-10-03 --max-gb 30 && "
                   ...
                   "python data_setup.py --build-index --source himawari9 --step-min 10 --time-step 0.5 --gap-levels 3 --multigap-levels 1 && "
                   "python data_setup.py --build-index --source insat3dr --step-min 30 --time-step 0.5 --gap-levels 2 --multigap-levels 1")
